...
Atenção! Ao inserir a cadeia de caracteres, não coloque espaço! Deixe tudo junto pois caso contrário por estar usando "scanf" ao invés de "gets" o programa não funcionará corretamente!
